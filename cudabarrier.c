...
int main(int argc, char **argv)
{
	...
	int device_id = rank % device_count;  // Choose device based on rank
	...
	samples = (sample*) mmap(0, samples_size, PROT_READ | PROT_WRITE,
	...
	data = (unsigned long long*)mmap(0, data_size, PROT_READ | PROT_WRITE,
		    MAP_ANONYMOUS | MAP_PRIVATE | MAP_POPULATE,
		    -1, 0);
